...
def test_netapp_switch_one():
    ...
    actual_output = search_strings(properties('check_point17_netapp_switch_string'), element_found.text)
    expected_output = properties('check_point17_netapp_switch_string')
