...
def test_ontap_deploy_guided_modal_number_one():
    ...
    type_in("ONTAP_post_deployment_guided_Hostname_xpath", properties_china("ONTAP_post_deployment_guided_Hostname"))
    type_in("ONTAP_post_deployment_guided_password_xpath", properties_china("ONTAP_post_deployment_guided_password"))
    ...
    actual_output = search_strings(properties_china("ONTAP_post_deployment_guided_modal_number_details"), found_element.text)
    expected_output = properties_china('ONTAP_post_deployment_guided_modal_number_details')
...
def test_ontap_deploy_os_version_two():
    ...
    actual_output = search_strings(properties_china("ONTAP_post_deployment_guided_os_version_details"), found_element.text)
    expected_output = properties_china('ONTAP_post_deployment_guided_os_version_details')
    print("Element Returned Test: ", found_element.text)
    highlight_element(found_element)
