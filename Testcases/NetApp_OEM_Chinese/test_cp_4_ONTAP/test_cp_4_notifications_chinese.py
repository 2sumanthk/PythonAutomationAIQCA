...
def test_ontap_notifications_one():
    ...
    expected_output = properties_china('check_point4_ONTAP_string_new_features1_string1')
...
def test_ontap_notifications_two():
    ...
    expected_output = properties_china('check_point4_ONTAP_string_new_features2_string2')
    print("Element Returned Test: ", actual_output.text)
    highlight_element(actual_output)
