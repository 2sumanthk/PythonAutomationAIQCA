...
def test_netapp_switch_one():
    ...
    actual_output = search_strings(properties_china('check_point17_netapp_switch_string'), element_found.text)
    expected_output = properties_china('check_point17_netapp_switch_string')
