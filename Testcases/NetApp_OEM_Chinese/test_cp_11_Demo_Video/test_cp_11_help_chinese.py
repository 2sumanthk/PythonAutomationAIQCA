...
def test_demo_video_one():
    ...
    expected_output = properties_china('check_point11_netapp_whats_new_string1')
...
def test_verify_demo_video_link_two():
    ...
    expected_output = properties_china('help_product_title_demo_video_link')
...
def test_verify_demo_video_site_title_three():
    ...
    switch_to_window(1)
    actual_output = title()
    expected_output = properties_china('verify_title_demo_video_string2')
    close_browser()
    assert actual_output == expected_output
