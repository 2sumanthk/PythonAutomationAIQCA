...
def test_copyrights_one():
    ...
    expected_output = properties_japan('help_product_copyrights_string1')
    print("Element Returned Test: ", found_element.text)
    actual_output = search_strings(properties_japan("help_product_copyrights_string1"), found_element.text)
...
def test_copyrights_two():
    found_element = find_element("help_product_copyrights_xpath")
    expected_output = properties_japan('help_product_copyrights_string2')
    print("Element Returned Test: ", found_element.text)
    actual_output = search_strings(properties_japan("help_product_copyrights_string2"), found_element.text)
    assert actual_output == expected_output
    close_browser()
    switch_to_window(0)
