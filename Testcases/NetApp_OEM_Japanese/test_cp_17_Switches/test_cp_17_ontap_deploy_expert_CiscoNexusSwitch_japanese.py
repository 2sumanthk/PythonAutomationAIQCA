...
def test_cisco_nexus_switch_one():
    ...
    actual_output = search_strings(properties_japan('ontap_deploy_expert_cisco_nexus_switch_add_string'), element_found.text)
    expected_output = properties_japan('ontap_deploy_expert_cisco_nexus_switch_add_string')
