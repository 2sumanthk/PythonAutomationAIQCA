...
def test_ontap_help_one():
    ...
    expected_output = properties_japan('help_aiq_supported_new_features_string1')
...
def test_ontap_help_two():
    ...
    expected_output = properties_japan('help_aiq_issues_addressed_new_features_string2')
    print("Element Returned Test: ", actual_output.text)
    highlight_element(actual_output)
