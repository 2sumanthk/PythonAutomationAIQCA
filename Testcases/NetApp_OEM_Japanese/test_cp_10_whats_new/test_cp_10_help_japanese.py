...
def test_whats_new_help_one():
    ...
    expected_output = properties_japan('check_point10_netapp_whats_new_string1')
...
def test_verify_whats_new_link_two():
    ...
    expected_output = properties_japan('help_product_title_whats_new_link')
...
def test_verify_whats_new_site_title_three():
    ...
    switch_to_window(1)
    actual_output = title()
    expected_output = properties_japan('verify_title_whats_new_string2')
    close_browser()
    assert actual_output == expected_output
